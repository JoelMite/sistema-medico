...
Route::middleware(['auth', 'role', 'state'])->group(function () {
  ...
  Route::get('/appointment_medicals/{appointment}/cancel', 'AppointmentMedicalController@showCancelForm'); // Al  ser este una actualizacion (update) podemos utilizar put p patch
