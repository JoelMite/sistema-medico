              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <div class="form-group" id="boton-collapse-3">
                    ...
                    aria-controls="contenido-btn-3">Prescripción Médica<i class="ni ni-check-bold text-white" ></i></button>
                  </div>
                  <!-- Contenedor -->
                ...
                <div class="form-group">
                  <div class="form-group" id="boton-collapse-4">
                    ...
                    data-target="#contenido-btn-4" aria-expanded="false"
                    aria-controls="contenido-btn-4">Pruebas de Laboratorio<i class="ni ni-check-bold text-white" ></i></button>
                  </div>
                  <!-- Contenedor -->
                  <div class="collapse" id="contenido-btn-4" aria-labelledby="boton-collapse-4"
                  data-parent="#acordeon-01">
                  <div class="form-row">
                      {{-- </div> --}}
                      ...
                      <div class="col-md-4 mb-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="type_of_exam" class="form-control form-control-lg" value="{{ old('type_of_exam') }}" required>
                      ...
                      <div class="col-md-1 mb-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="quantity" class="form-control form-control-lg" value="{{ old('quantity') }}" required>
