                                  ...
                                  <table class="table table-striped table-bordered">
                                      <tbody>
                                          ...
                                          <tr>
                                              ...
                                              <td class="alert alert-danger" v-if="info.status == 'Cancelada'">{{info.status}}</td>
                                              <td class="alert alert-success" v-if="info.status == 'Atendida'">{{info.status}}</td>
                                              <!-- <td>{{info.status}}</td> -->
                                          </tr>
                                          ...
                                          <tr v-if="info.cancellation_justification">
                                              ...
                                              <td>{{info.cancelletion_by.person.name}}  {{info.cancelletion_by.person.lastname}}</td>
                                          </tr>
                                      </tbody>
                                  </table>
                              </div>
...
export default {
    ...
    mounted() {
        ...
        this.$root.$on('pending_cancel', () => {
          this.getAppointments();
        });
        this.$root.$on('confirm_old', () => {
          this.getAppointments();
        });
